...
// const notes = ['fdjksldafjsdkl', 'fhdjksdahfksd', 'dhjjewfewhsadhsdjsdh']
const notes = [
    {
        title: 'fdjksldafjsdkl',
        action: false,
    }, 
    {
        title: 'fhdjksdahfksd',
...
function arrayNote(){
    ...
    if(notes.length ===0){
        listsEl.innerHTML = '<p class="option">Заметок нет</p>'
    }
